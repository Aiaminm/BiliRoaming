...
class BangumiSeasonHook(classLoader: ClassLoader) : BaseHook(classLoader) {
    ...
    private fun fixSpace(data: Any?, mid: String, getUrlContent: String): Any? {
        ...
        val name = content.getObjectField("name")
        Log.d("11111.2")
        Log.d(name)
        val sex = content.getObjectField("sex")
        val rank = content.getObjectField("rank")
        val face = content.getObjectField("face")
        val sign = content.getObjectField("sign")
        ...
        val official_verify_desc = content.optJSONObject("official_verify")?.getObjectField("desc")
